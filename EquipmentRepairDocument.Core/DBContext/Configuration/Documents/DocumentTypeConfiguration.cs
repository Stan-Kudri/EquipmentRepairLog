...
namespace EquipmentRepairDocument.Core.DBContext.Configuration.Documents
{
    public class DocumentTypeConfiguration : EntityBaseConfiguration<DocumentType>
    {
        protected override void ConfigureModel(EntityTypeBuilder<DocumentType> builder)
        {
            ...
            builder.Property(x => x.MultipleUseInERD).HasColumnName("is_single_type_document").IsRequired().HasDefaultValue(false);
